...
public interface ApplicationRepository extends JpaRepository<Application,Long> {
    ...
    @Query(value="SELECT a.applicantsafm, a.description, a.location, a.state, a.staff_id, a.application_id FROM application a INNER JOIN users u ON (a.applicantsafm = u.afm) WHERE u.username = :email ", nativeQuery = true)
